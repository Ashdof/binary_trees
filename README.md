...
In this project, we were introduced to the concepts of *Binary Trees*, *Binary Search*, *ALV Trees* and *Binary Heap* 

# General Objectives
At the end of the lesson, we were able to
- Explain a binary tree
- State the difference between a binary tree and a Binary Search Tree
- Identify the possible gain in terms of time complexity compared to linked lists
- Explain the depth, the height, the size of a binary tree
- Explain the different traversal methods to go through a binary tree
- Define a complete, a full, a perfect, a balanced binary tree
